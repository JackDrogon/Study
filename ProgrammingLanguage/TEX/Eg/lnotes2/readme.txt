...
2.2 Simpsons Package http://ctan.org/pkg/simpsons/
    1) 下载 simpsons.sty，放到 MIKTEX-ROOT/tex/latex/simpsons/目录.
    2) MikTeX -> Maintainence -> Settings -> General -> Refresh FNDB 或在命令行下执行 initexmf --update-fndb.

2.3 字体
    源码中不包含字体，读者请自行准备，或修改 lnotes2.tex 文件中第9--16行。
...
1) ** WARNING ** Image format conversion for PSTricks failed.
    ...
    从 miktex\root\dvipdfm\config\dvipdfmx.cfg 里复制下面带D参数的那行，粘贴到上面那个文件里。那行一般是这样的，
