...
1994年之后，Taco Hoekwater\indexHoekwater{} \footnote{曾学习艺术史和哲学，1992年辍学加入荷兰军队。退伍后加入克鲁沃学术出版公司 (Kluwer Academic Publishers)\indexKluwer ，2000年跳槽到精灵公司 (Elvenkind)\indexElvenkind 。LuaTeX和Con\TeX{}t的开发者之一。} 和Hagen等人接管了 \MP 的开发和维护工作。若想深入了解，可以参阅其用户手册\citep{Hobby_2010}。
